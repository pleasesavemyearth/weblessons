...
<body>
  ...
  <ol>
    <li>데이터베이스생성(init_createdb.php 파일 참조) </li>
    DBMS 시스템과의 연결, Database(toymembership) 생성하는 시스템 초기화 기능.
    <a href="init_createdb.php">실행</a>
    <li>테이블생성(init_createtbl.php 파일 참조)</li>
    ...
    <a href="init_createtbl.php">실행</a>
    ...
    <a href="user_registform.php">실행</a>
    <li>회원가입 처리(user_registproess.php)</li>
    <li>사용자 로그인 화면(user_loginform.html></li>
    <a href="user_loginform.php">실행</a>
    <li>로그인 처리(user_loginproess.php)</li>
    <li>로그인 성공 페이지(user_loginsuccess.php)
      사용자 목록 확인
      <a href="user_loginsuccess.php">실행</a>
    <li>사용자 상세 정보 화면(userdetailview.php)</li>
